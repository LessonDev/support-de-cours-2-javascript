...
console.log( "aimez vous le football:" + likeFootball + ",est de type - " + typeof(likeFootball) );
console.log( "variable qui s'appelle otherStuff:" + otherStuff + ", est de type - " + typeof(otherStuff) );
